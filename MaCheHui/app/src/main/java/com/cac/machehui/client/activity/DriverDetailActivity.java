 ...
 * 车型页面
 */
public class DriverDetailActivity extends BaseActivity implements
		OnClickListener {
	...
	private void getDataFromServer() {
		...
		httpHandler = httpUtils.send(HttpMethod.GET, URLCst.GET_MODEL_BRAND,
				params, new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> arg0) {
						...
						if (TextUtils.isEmpty(result)) {
							Toast.makeText(DriverDetailActivity.this, "返回数据异常",
	...
	private void iniView() {
		...
		mAdapter = new DriverLineAdapter(DriverDetailActivity.this,
				carBrandBeanList);
		...
		sortListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				bundle.putString("modle", carLineBean.Text);
				bundle.putString("carBrand", carBrand);
				intent.putExtras(bundle);
				intent.setClass(DriverDetailActivity.this,
