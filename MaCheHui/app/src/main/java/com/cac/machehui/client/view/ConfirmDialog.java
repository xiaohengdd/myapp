...
public class ConfirmDialog extends Dialog {
	 ...
	 */
	public void setOnButton1ClickListener(String text, Integer colorId,
										  final OnButton1ClickListener onButton1ClickListener) {
	 ...
	 * @update 2014年6月22日 下午12:34:39
	 */
	public void setOnButton1ClickListener(Integer textId, Integer colorId,
										  final OnButton1ClickListener onButton1ClickListener) {
		Button button1 = (Button) confirmDialog.findViewById(R.id.button1);
		if (colorId != null)
			button1.setTextColor(context.getResources().getColor(colorId));
	 ...
	 * @update 2014年6月22日 下午12:34:39
	 */
	public void setOnButton2ClickListener(String text, Integer colorId,
										  final OnButton2ClickListener onButton2ClickListener) {
	 ...
	 * @update 2014年6月22日 下午12:34:39
	 */
	public void setOnButton2ClickListener(Integer textId, Integer colorId,
										  final OnButton2ClickListener onButton2ClickListener) {
		Button button2 = (Button) confirmDialog.findViewById(R.id.button2);
		if (colorId != null)
			button2.setTextColor(context.getResources().getColor(colorId));
